/*
    ...
    Description:    This header contains definitions for the version strings.

*/

#ifndef  MINESWEEPER_VERSION_HPP_
#define  MINESWEEPER_VERSION_HPP_
...
#endif  // MINESWEEPER_VERSION_HPP_
